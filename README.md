...
composer require fasaro/magento2-es_hn-language-pack dev-master
php bin/magento setup:static-content:deploy es_HN
...
```
php bin/magento maintenance:enable
composer update fasaro/magento2-es_hn-language-pack dev-master
php bin/magento setup:static-content:deploy es_HN
php bin/magento indexer:reindex
php bin/magento cache:clean
php bin/magento cache:flush
